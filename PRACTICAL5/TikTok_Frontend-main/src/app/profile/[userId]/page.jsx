...
export default function ProfilePage() {
  ...
  // Set up infinite query for user videos
  const {
    data,
    error,
    fetchNextPage,
    ...
    queryFn: ({ pageParam }) => getUserVideos({ id: userId, cursor: pageParam }),
      ...
      <div className="py-4">
        {activeTab === 'videos' ? (
          <>
            ...
            {/* End of feed message */}
            {status === 'success' && !hasNextPage && data?.pages[0]?.videos.length > 0 && (
